...
[![NeuTherm-PINN](https://img.shields.io/badge/NeuTherm--PINN-Physics--Informed%20ML%20for%20Nuclear%20Reactors-EE4C2C?style=for-the-badge&logo=pytorch&logoColor=white)](https://github.com/carcaraa/neutherm-pinn-v2)
...
Built from scratch: numerical solvers, cross-section models (Doppler feedback), dataset generation (Latin Hypercube), training pipelines, and comparison benchmarks. **[See the repo →](https://github.com/carcaraa/neutherm-pinn-v2)**

## Featured projects

| Project | What it does | Stack |
|---------|-------------|-------|
| [**neutherm-pinn-v2**](https://github.com/carcaraa/neutherm-pinn-v2) | PINNs for coupled neutronics–thermal hydraulics in nuclear fuel elements | PyTorch · NumPy · SciPy |
